/**
 * Metasearch January 2026 breakdown data utilities.
 * Hardcoded override used when the display-data API returns incorrect breakdowns for that period.
...
export const JAN_2026_DIMENSION_MAP: Record<string, string> = {
...
export const HARDCODED_JAN2026_RAW_DATA_ROWS = breakdownToRawDataRows(
