...
export const syncDataSource = async (
  dataSource: any,
  options: any = {}
): Promise<{success: boolean, rowsProcessed: number, dimensionsCreated: number, error?: string}> => {
  console.warn('[SYNC] syncDataSource is deprecated. Use runRefreshWorkflow instead.');
  throw new Error("syncDataSource is deprecated. Use runRefreshWorkflow instead.");
};
